...
def change_info(request):
    if request.method=='POST':
        ...
        if change_info_form.is_valid():
            ...
            email=change_info_form.cleaned_data['email']
            ...
            user_info.save()
            change_info_form=ChangeInfoForm(initial={'username':user.username,'email':user.email,'text':user_info.introduction}) #设置表单value
    else:
